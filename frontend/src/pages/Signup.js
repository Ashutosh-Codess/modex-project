...
function Signup() {
    ...
    var _e = (0, react_1.useState)(''), msg = _e[0], setMsg = _e[1];
    var _f = (0, react_1.useState)(false), busy = _f[0], setBusy = _f[1];
    var _g = (0, react_1.useState)(''), emailError = _g[0], setEmailError = _g[1];
    var _h = (0, react_1.useState)(''), nameError = _h[0], setNameError = _h[1];
    var _j = (0, react_1.useState)(''), passwordError = _j[0], setPasswordError = _j[1];
    ...
    var submit = function (e) { return __awaiter(_this, void 0, void 0, function () {
        var isEmailValid, isNameValid, isPasswordValid, e_1, errorMsg;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, signup(name, email, password)];
                case 2:
                    _c.sent();
                ...
                case 3:
                    e_1 = _c.sent();
                    errorMsg = ((_b = (_a = e_1 === null || e_1 === void 0 ? void 0 : e_1.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || 'Signup failed. Please try again.';
                    setErr(errorMsg);
                    return [3 /*break*/, 4];
                case 4:
                    setBusy(false);
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div>
            ...
            color: nameError ? '#ff6b6b' : '#999'
              ...
              <input type="text" placeholder="Full Name" value={name} onChange={function (e) {
            setName(e.target.value);
            if (e.target.value)
                validateName(e.target.value);
        }} onBlur={function () { return validateName(name); }} style={{
            width: '100%',
            padding: '0.875rem 1rem 0.875rem 3rem',
            border: "2px solid ".concat(nameError ? '#dc3545' : '#444'),
            borderRadius: '12px',
            fontSize: '1rem',
            outline: 'none',
            transition: 'all 0.2s',
            ...
            {nameError && (<p style={{ color: '#ff6b6b', fontSize: '0.875rem', marginTop: '0.5rem', marginLeft: '4px' }}>
                {nameError}
              </p>)}
          </div>
          ...
          <div>
            ...
            color: passwordError ? '#ff6b6b' : '#999'
              ...
              <input type="password" placeholder="Password (min 6 characters)" value={password} onChange={function (e) {
            setPassword(e.target.value);
            if (e.target.value)
                validatePassword(e.target.value);
        }} onBlur={function () { return validatePassword(password); }} style={{
            width: '100%',
            padding: '0.875rem 1rem 0.875rem 3rem',
            border: "2px solid ".concat(passwordError ? '#dc3545' : '#444'),
            borderRadius: '12px',
            fontSize: '1rem',
            outline: 'none',
            transition: 'all 0.2s',
            ...
            {passwordError && (<p style={{ color: '#ff6b6b', fontSize: '0.875rem', marginTop: '0.5rem', marginLeft: '4px' }}>
                {passwordError}
              </p>)}
          </div>

          <button type="submit" disabled={busy || !!emailError || !!nameError || !!passwordError} style={{
            width: '100%',
            padding: '1rem',
